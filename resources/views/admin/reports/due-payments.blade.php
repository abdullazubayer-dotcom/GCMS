<x-layouts.app title="Due Payment Report - GCMS">
    @include('admin.reports.partials.print-style')

    <div class="d-flex justify-content-between align-items-start mb-4 no-print">
        <div>
            <h1 class="h3 mb-1">Due Payment Report</h1>
            <p class="text-muted mb-0">Shows only due and partial payments.</p>
        </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <a href="{{ route('admin.reports.due-payments') }}" class="btn btn-outline-secondary">Reset</a>
                </div>
            </div>
        </div>
    </form>

    @include('admin.reports.partials.payment-table', ['title' => 'Due Payment Report', 'payments' => $payments, 'totalAmount' => $totalAmount])
</x-layouts.app>
